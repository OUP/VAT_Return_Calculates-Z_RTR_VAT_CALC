		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "VAT Return Calculates",
									"targetURL": "#ouprtrvatreturncalc-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ouprtrvatreturncalc-display": {
								"semanticObject": "ouprtrvatreturncalc",
								"action": "display",
								"description": "VAT Return calculates how much VAT you owe HMRC",
								"title": "VAT Return Calculates",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=oup.rtr.vatreturncalc",
									"url": sap.ui.require.toUrl("oup/rtr/vatreturncalc")
								}
							}
						}
					}
